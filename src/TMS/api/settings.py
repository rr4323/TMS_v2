...
SECRET_KEY = 'django-insecure-^i@cn)c_cql$n=9pi#69+b2d6$bb+9-u9$clz@)_#vi$+5)w-i'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'filters': ['secret_filter'],
            'filename': os.path.join(LOG_PATH, '{:%Y-%m-%d}.log'.format(datetime.now())),
            'formatter': 'debug'
        },
        'error': {
            'level': 'WARN',
